//Ex37
/*
As tarifas de certo parque de esctacionamento são as seguintes:
        1ª e 2ª hora - R$1,00 cada
        3ªa e 4ª hora - R$1,40 cada
        5ª hora e seguintes - R$2,00 cada

O número de horas a pagar é sempre inteiro e arredondado por excesso. Deste modo,
quem estacionar durantee 61 minutos pagará por duas horas, que é o mesom que pagaria
...
Por exemplo, o par 12 50 respresentará "dez para uma da tarde". Pretende-se criar um
...
intervalo não superior a 24 horas. Portanto, se uma dada hora de chegada for superior à
da partida, isso não é uma situação de erro, antes significará que a partida ocorreu no
...
atual (use uma constante definida com o valor igual a 2008). Imprimir: "data válida" ou
"data inválida" no final da execução do programa.
*/
