...
Variables are the names you give to computer memory locations which are used to stores values in a 
...
Decalring a variable is when you specify the type of the variable followed by the variable name.
