...
Sometimes when I program is created that recquires the developer to enter a small amount of information
at the terminal.

This information must consist of a number indicating the triangular number that you want to have 
calculated or a word that you want to have looked up in a dictionary
